...
export const AuthForm: React.FC<AuthFormProps> = ({ onSuccess }) => {
  ...
  // Handler para login social (Google e Facebook)
  const handleSocialLogin = async (provider: 'google' | 'facebook') => {
    ...
    try {
      ...
      if (error) throw error;
      // Sucesso será tratado pelo listener de mudança de estado de autenticação
    } catch (err: any) {
      setError(getErrorMessage(err));
    } finally {
  ...
  // Ícone do Google para botão de login social
  const GoogleIcon = () => (
  ...
  // Ícone do Facebook para botão de login social
  const FacebookIcon = () => (
          ...
          <div className="mb-6">
            ...
            <div className="grid grid-cols-2 gap-3">
              ...
              <button
                ...
                className="inline-flex justify-center items-center py-3 px-4 border border-gray-300 rounded-lg bg-white text-sm font-medium text-gray-700 hover:bg-gray-50 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-blue-500 transition-colors disabled:opacity-50 disabled:cursor-not-allowed"
              >
